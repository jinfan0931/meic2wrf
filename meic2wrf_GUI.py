        ...
        #aerosol: ton/(grid.month) to ug/(m2.s)
            ...
            time_inp+'_11:00:00',]):
             ...
             'E_OL2','E_OLI','E_OLT','E_ORA2','E_TOL','E_XYL',]
                ...
                #f_chem.variables[gas].FieldType = 104
                    f_chem.variables[gas].MemoryOrder = 'XYZ'
                    f_chem.variables[gas].description = 'EMISSION'
                    f_chem.variables[gas].units = 'mol km^-2 hr^-1'
                    f_chem.variables[gas].stagger = ''
                ...
                #f_chem.variables[aerosol].FieldType = 104
                    f_chem.variables[aerosol].MemoryOrder = 'XYZ'
                    f_chem.variables[aerosol].description = 'EMISSION'
                    f_chem.variables[aerosol].units = 'ug/m3 m/s'
                    f_chem.variables[aerosol].stagger = ''
